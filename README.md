...
Patch content
```
curl -X PATCH -d '[ { "op": "replace", "path": "publish_date", "value": "2020-06-06T00:00:00.000Z" }]' "localhost:26400/cms/LMSV1/aboutus" | jq
curl -X PATCH -d '[ { "op": "replace", "path": "approved", "value": "true" }]' "localhost:26400/cms/LMSV1/aboutus" | jq
curl -X PATCH -d '[ { "op": "replace", "path": "content", "value": "eyAid3V0Ijoid2F0IiB9" }]' "localhost:26400/cms/LMSV1/aboutus" | jq
```
